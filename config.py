...
START_HERE_CHANNEL_ID = 809368762812989440
...
RAID_TOOLS_FORUM_ID = 1535621607815385122
TIMELINE_REMINDER_THREAD_ID = 1535621623091302422
ARCHON_APP_THREAD_ID = 1535621644645564557
BOT_SUGGESTIONS_CHANNEL_ID = 1530215989499662478
TACTICS_NOTIFICATION_CHANNEL_ID = 810474409755541524
FLOOD_CHANNEL_ID = _int_env("FLOOD_CHANNEL_ID", 810474409755541524)
LOOT_HISTORY_CHANNEL_ID = 1055007278593482822
RAID_ANALYSIS_CHANNEL_ID = 1345828084640776343
SUPPORTERS_CHANNEL_ID = _int_env("SUPPORTERS_CHANNEL_ID", 809368762812989440)
NITRO_BOOSTER_ROLE_ID = _int_env("NITRO_BOOSTER_ROLE_ID", 610008435467223071)
RAID_NOTICE_EMOJI = "✅"
...
PUBLISHED_LINK_CHECK_INTERVAL_HOURS = 24

FRZOK_USER_ID = _int_env("FRZOK_USER_ID", 197371266007564289)
MIVIVAN_USER_ID = _int_env("MIVIVAN_USER_ID", 543752964179755018)
KELSARAN_USER_ID = _int_env("KELSARAN_USER_ID", 228064558831370241)
...
MESSAGES = {
    "GUEST_WELCOME_MESSAGE": (
        ...
        "Тебе временно выдана роль **Гости**. Она позволяет познакомиться "
        "с сервером и связаться с руководством гильдии.\n\n"
        "## С ЧЕГО НАЧАТЬ\n"
        "• Прочитай [правила и карту сервера]"
        "(https://discord.com/channels/604571954422218752/809368762812989440).\n"
        "• Если ты состоишь в гильдии или хочешь попасть в основной состав, "
        "напиши <@197371266007564289> и укажи ник персонажа и игровой сервер.\n"
        "• Вопросы по ролям, доступу и привязке персонажей также направляй "
        "<@197371266007564289>."
    ),
    "WELCOME_MESSAGE": (
        "# ⚔️ Тебе присвоена роль «Сержант»!\n\n"
        "Добро пожаловать в основной состав Shadow Squad. Получение роли "
        "означает согласие с [правилами гильдии]"
        "(https://discord.com/channels/604571954422218752/809368762812989440).\n\n"
        "## ПЕРЕД ПЕРВЫМ РТ\n"
        "`1` Установи и настрой обязательные аддоны в "
        "[форуме рейдовых инструментов]"
        "(https://discord.com/channels/604571954422218752/1535621607815385122).\n"
        "`2` Скачай актуальный архив в теме "
        "[Timeline Reminder]"
        "(https://discord.com/channels/604571954422218752/1535621623091302422).\n"
        "`3` Настрой Archon App и проверь запись VoD.\n"
        "`4` Изучи материалы в [форуме тактик]"
        "(https://discord.com/channels/604571954422218752/1485886206817599569).\n"
        "`5` Перед первым РТ сообщи офицеру, что подготовка завершена. "
        "Офицеры проверят её по служебному чек-листу.\n\n"
        "## РАСПИСАНИЕ\n"
        "Обязательные РТ: **пятница и воскресенье, 21:00–00:00 МСК**, "
        "голосовой канал [⚔️РТ・Спец-отряд]"
        "(https://discord.com/channels/604571954422218752/713419816857370624).\n\n"
        "Если не сможешь прийти или опоздаешь, заранее сообщи в "
        "[🐷отсутствия-и-опоздания]"
        "(https://discord.com/channels/604571954422218752/1200807297111306280) "
        "и дождись реакции ✅ от бота.\n\n"
        "Нужный раздел сервера можно быстро найти командой `/где`. "
        "Вопросы по ролям и персонажам направляй <@197371266007564289>."
    ),
